...
| D-40 | Eşya | Büyütme Tobu — kendini büyütme |
...
| ID | Kategori | Özet |
|----|----------|------|
| P-01 | Zırh | Ametist Zırh — giyildikten sonra çıkarılamaz, Enerji Kristali ile gevşetme |
| P-02 | Eşya | Kara Delik — canlıları kör eder, çeker, hasar verir |
| P-03 | Eşya | Yıldırım Büyüsü — baktığın yere yıldırım çaktırır, 32 kullanım |
| P-04 | Eşya | Kontrol Kumandası — 25 blok yarıçapındaki canlıları 1.5 dk dondurur |
| P-05 | Blok | Blocker Sandık — sadece sahibi açabilir, başkaları anında ölür |
| P-06 | Mob | Ender Send — 20 blok boyunda dev düşman mob, 300 HP |
