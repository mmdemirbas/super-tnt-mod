...
[Belgeler](https://mmdemirbas.github.io/super-tnt-mod/) ·
...
![70 TNT, paketin kendi dokularıyla](docs/guide/tnt-duvari.svg)
...
<!-- katalog -->
**v1.51.0 · 70 TNT · 51 blok · 53 eşya · 4 canavar · 135 kılık** — tam liste [katalogda](https://mmdemirbas.github.io/super-tnt-mod/katalog.html).
<!-- /katalog -->
...
ayarlarında davranış ve kaynak paketini etkinleştirin. Ayrıntılar:
[Kurulum](https://mmdemirbas.github.io/super-tnt-mod/kurulum.html).
...
Oyun içi ipuçları her TNT ve eşyanın üzerinde yazar; eşya kılavuzları
[belgelerde](https://mmdemirbas.github.io/super-tnt-mod/kilavuz.html).
...
| `docs/guide/` | Belge sitesi (oku ile derlenir, GitHub Pages'te yayımlanır). |
...
python3 scripts/katalog.py     # katalog sayfası ve README özeti
python3 scripts/tnt_duvari.py  # TNT duvarı (docs/guide/tnt-duvari.svg)
