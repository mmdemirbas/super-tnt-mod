- [X] Büyüme ve küçültme TNT'leri sınırsız büyütüp küçültmeli, zaten sıfırlamak için ayrı bir TNTmiz
  var istediğimiz zaman onu kullanabiliriz.
- [X] Blok'tan 12 kat daha küçük hale gelince otomatik olarak elimize bir item gelecek. Bu item'ı
...
- [X] Portal silahı: Lego bloklarından yapılır. Lego blokları crafting table'da ortaya pembe,
  ...
  edilir, önce pembe sonra yeşil portal açar. Yani bir ateş etmede pembe, ikincide yeşil portal
  açar. Bir pembe açılınca diğer pembe otomatik kapanır, bir yeşil açılınca diğer yeşil otomatik
  kapanır. Aynı anda hangi pembe ve yeşil portal mevcut ise onlardan birbirine ışınlanabilir.