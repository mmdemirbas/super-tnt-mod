...
public class NetherPearlEntityRenderer extends EntityRenderer<NetherPearlEntity, TntEntityRenderState> {

    public NetherPearlEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
    }
    ...
    public void render(TntEntityRenderState state, MatrixStack matrices,
        ...
        renderCommands.submitBlock(matrices, Blocks.NETHERRACK.getDefaultState(), state.light, 0, 0);
        matrices.pop();
