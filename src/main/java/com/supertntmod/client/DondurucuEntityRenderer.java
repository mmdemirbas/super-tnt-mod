...
/**
 * Dondurucu renderer: küçük denizin kalbi temalı küp (prismarine).
 */
public class DondurucuEntityRenderer extends EntityRenderer<DondurucuEntity, TntEntityRenderState> {

    public DondurucuEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
    }
    ...
    public void render(TntEntityRenderState state, MatrixStack matrices,
        ...
        renderCommands.submitBlock(matrices, Blocks.DARK_PRISMARINE.getDefaultState(), state.light, 0, 0);
        matrices.pop();
